...
import { faCogs, faExternalLinkAlt, faLayerGroup, faPalette, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
...
import $ from 'jquery';
import { NavigationSidebar } from '@/routers/ServerElements';
            ...
            >
                ...
                <div className='side-wrapper'>
                    ...
                    <div className='side-menu'>
                        <NavLink to={'/'} className='sidebar-link' isActive={() => false}>
                            ...
                            <>
                                ...
                                {rootAdmin && (
                                    ...
                                    <a
                                        ...
                                        target={'_blank'}
                                    >
                                        <FontAwesomeIcon icon={faExternalLinkAlt} css={tw`!w-8 h-8`} /> Manage
                                    </a>
                                )}
                            </>
                        )}
